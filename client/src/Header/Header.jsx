            ...
            {userExist && (
                <nav className="hidden lg:flex space-x-7 font-medium text-md">
                    <NavLink to="/" end className={({ isActive }) => 
                        `pb-1 ${isActive ? "border-b-4 border-[#d0b797] text-gray-900" : "hover:border-b-4 hover:border-[#d0b797] hover:text-gray-600"}`
                    }>
                        Home
                    </NavLink>
                    ...
                    <NavLink to="/techtutorial" className={({ isActive }) => 
                        `pb-1 ${isActive ? "border-b-4 border-[#d0b797] text-gray-900" : "hover:border-b-4 hover:border-[#d0b797] hover:text-gray-600"}`
                    }>
                        Tech Tutorial
                    </NavLink>
            ...
            {isOpen && (
                <div className="z-20 absolute top-20 left-0 w-full bg-white shadow-md flex flex-col items-center space-y-4 py-6 lg:hidden">
                    {userExist && (
                        <>
                            <NavLink to="/" end className={({ isActive }) => 
                                `pb-1 ${isActive ? "border-b-2 border-[#d0b797]" : "hover:border-b-2 hover:border-[#d0b797] hover:text-gray-600"}`
